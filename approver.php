...
?>
<p>&nbsp;</p>
<form method='POST' action='approver_proc.php'>
<input type='hidden' name='employee_id' value='<?php echo $employee_id; ?>'>
<table border='0' width='60%'>
<tr><td align="center">
<input type='submit' value='APPROVE' name='approve' onclick='return confirm("you are about to APPROVE this form");' />
<input type='submit' value='Return to Review' name='return_to_review' onclick='return confirm("you are about to RETURN this form for reviewing");' />
<textarea name="reviewing_manager_comment" rows="10" placeholder="You can add comments here ......"></textarea>
</td></tr>
</table>
</form>
<p>&nbsp;</p>
