...
<table width="90%" border="0">
  ...
  <table width="60%" border="0">
    <tr>
	<td><font color="blue" style='font-family: Courier New; font-size: 15px;'><strong>Human Resources Department - Training & Development Section<br />
      Performance Management System <?php echo date('Y'); ?></strong></font></td>
	</tr>
