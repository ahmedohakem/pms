...
$CheckQur = mysqli_query ($conn, "SELECT * FROM sys_users WHERE username = '".$_POST["uname"]."' AND user_password = '".mysqli_real_escape_string($conn, MD5($_POST['upassword']))."' AND user_status = 'ACTIVE' AND user_level LIKE  '_1%'");
